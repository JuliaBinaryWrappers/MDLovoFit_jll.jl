# `MDLovoFit_jll.jl` (v20.1.0+0)

[![deps](https://juliahub.com/docs/MDLovoFit_jll/deps.svg)](https://juliahub.com/ui/Packages/MDLovoFit_jll/qXkyY?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/dcbd4fec93010c377c71e975dfcac255f3bff421/M/MDLovoFit/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `MDLovoFit_jll.jl` have been built from these sources:

* git repository: https://github.com/m3g/MDLovoFit.git (revision: `770fa230c76f21a6cd192ce8dc247805edae47a5`)

## Platforms

`MDLovoFit_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `MDLovoFit_jll.jl`:
